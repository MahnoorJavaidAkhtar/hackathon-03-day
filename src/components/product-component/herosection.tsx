    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      ...
      <div className="max-w-[1050px] bg-white border border-gray-200 shadow-lg rounded-lg mt-10 grid grid-cols-2 lg:grid-cols-2 gap-0 w-1440 h-[598px]">
        ...
        <div className="relative">
          <img
            src="/carousel-inner.png" // Replace with actual image URL
            alt="Floating Phone"
            className="w-506 rounded-t-lg object-cover h-450"
          />
          <div className="absolute bottom-4 left-4 flex flex-row gap-2">
            <img
              src="/single-product-1-thumb-1.png" // Replace with thumbnail images
              alt="Thumbnail 1"
...
const Details = () => {
  return (
    <div className="mt-10 py-4 wrapper bg-cover bg-center"style={{ backgroundImage: "url('/pink.jpg')" }}>
      {/* Navigation Tabs */}
